...
class ZFS:
    ...
    def get_dataset(identifier):
        with libzfs.ZFS() as zfs:
            return zfs.get_dataset(identifier).__getstate__()
    ...
    def get_dataset_safely(self, dataset_name):
        try:
...
class Jail(Resource):
    ...
    def path(self):
        ...
        if self.zfs.get_dataset_safely(
    ...
    def jail_dataset(self):
        return self.zfs.get_dataset_safely(self.path)

    @property
    def root_dataset(self):
        return self.zfs.get_dataset_safely(
    ...
    @property
    def exists(self):
        return self.zfs.get_dataset_safely(self.path) is not None
...
class ResourceSelector:
    ...
    @property
    def iocage_dataset(self):
        return self.zfs.get_dataset_safely(f'{self.zfs.pool}/iocage')
